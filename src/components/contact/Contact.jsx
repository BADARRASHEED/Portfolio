        ...
        <div className="contact_content">
          ...
          <div className="contact_info">
            <div className="contact_card">
              ...
              <span className="contact_card_data">badarbutt354@gmail.com</span>

              <a
                href="mailto:badarbutt354@gmail.com.com"
            ...
            <div className="contact_card">
              ...
              <span className="contact_card_data">+92 3157706957</span>

              <a
                href="https://api.whatsapp.com/send?phone=03157706957&text=Hello, more information!"
                className="contact_button"
              >
                Write me
                <i className="bx bx-right-arrow-alt contact_button_icon"></i>
